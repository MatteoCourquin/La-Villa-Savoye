	...
	<body>
		...
		<article id="zone_article">
			<div id="article1" class="article">
				...
				<p>A 20-minute walk from Poissy train station, come and discover one of the masterpieces of architect Le Corbusier built between 1928 and 1931: the Villa Savoye. It was classified as a historical monument in 1965 and a UNESCO World Heritage Site in 2016.</p>
				<p id="masque1" class="masques">A desire for the countryside submitted to Le Corbusier by the Savoye couple gave birth to building. The major innovations dared by Le Corbusier almost a century ago can still and still appear relevant to us.<br><br>
			...
			<div id="article3" class="article">
				<img src="../images/blog/article3.jpg">
			...
			<div id="article4" class="article">
				<img src="../images/blog/article4.jpg">
				<h1>Yvelines. Visites guidées, résidence artistique, nouvel ouvrage : ça bouge à la Villa Savoye de Poissy</h1>

				<p>Visites guidées depuis le jardin, création chorégraphique filmée sur place et visible sur Francetv Culturebox, nouvelle édition d’un ouvrage… La Villa Savoye de Poissy (Yvelines) n’oublie pas son public, même si l’intérieur de la villa reste fermé, confinement oblige.</p>

				<p id="masque4" class="masques">Célèbre maison imaginée par l’architecte Le Corbusier, la Villa Savoye de Poissy est fermée au public depuis la fin octobre. Néanmoins, le site, géré par le Centre des monuments nationaux, propose plusieurs actualités à l’attention du public.<br><br>
			...
			<div id="article5" class="article">
				<img src="../images/blog/article5.jpg">
				...
				<p id="masque5" class="masques">Présences animales et humaines
			...
			<div id="article6" class="article">
				<img src="../images/blog/article6.jpg">
				...
				L'occasion de faire découvrir aux enfants de 5 à 12 ans et à leurs parents toute la richesse du patrimoine architectural, culturel et historique français grâce à de nombreuses activités ludiques et pédagogiques à Paris, en Ile-de-France et dans la France entière.</p>

				<p id="masque6" class="masques">A Poissy, en région parisienne, la Villa Savoye - une jolie maison moderniste signée Le Corbusier et construite entre 1928 et 1931 - ouvre ses portes gratuitement aux plus jeunes pour une activité "Imprime ta villa Savoye!" super fun.<br><br>
